...
assert.match(pipeline, /pdf-v(?:6-page-structured|7-layout-ir)/);
...
assert.match(app, /v14_(?:1_pdf_engine_v6|1a_semantic_variant_binding_v1|2_universal_document_ir_v1)/);
...
console.log("  cache schema is v14.1+ compatible");
